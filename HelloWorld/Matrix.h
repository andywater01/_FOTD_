...
public:
	...
	//For adding two mat3s together
	mat3 operator+(mat3 m);
	//For subtracting two mat3s
	mat3 operator-(mat3 m);
	//For multiplying mat3 by float
	mat3 operator*(float f);
	//For multiplying two mat3s
	mat3 operator*(mat3 m);
	//Negates the matrix
	mat3 operator-();
	//For use so that you can index the matrix using [] operator
...
public:
	...
	//For adding two mat4s together
	mat4 operator+(mat4 m);
	//For subtracting two mat4s
	mat4 operator-(mat4 m);
	//For multiplying mat4 by float
	mat4 operator*(float f);
	//For multiplying two mat4s
	mat4 operator*(mat4 m);
	//For use so that you can index the matrix using [] operator
	vec4 operator[](int i);
	//Multiplies the matrix with a 3D vector
...
public:
	...
	void Add(mat2 m);
	//Subtracts from the curent mat2
